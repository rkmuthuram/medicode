...
export default {
  ...
  methods: {
    ...
    async getAccount() {
  try {
   const response = await this.axios.get('https://backend.medicodesolution.com/staging/vendor/'+ this.vendorId)
    ...
    onSubmit(e) {
      ...
      self.$validator.validateAll().then((result) => {
		  if (result) {
                ...
                self.axios.patch('https://backend.medicodesolution.com/staging/vendor/'+ self.data.id, {
