...
export default {
  ...
  try {
   const response = await this.axios.get('https://backend.enigmedsvcs.com/development/manufacturerTypes')
  ...
  try {
   const response = await this.axios.get('https://backend.enigmedsvcs.com/development/packingTypes')
   this.packingTypes = response.data.packingTypes;
    ...
    async getAccount() {
  try {
   const response = await this.axios.get('https://backend.enigmedsvcs.com/development/medicine/'+ this.medicineId)
    ...
    onSubmit(e) {
      ...
      self.$validator.validateAll().then((result) => {
		  if (result) {
                ...
                self.axios.patch('https://backend.enigmedsvcs.com/development/medicine/'+ self.medicineId, {
