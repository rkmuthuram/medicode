   ...
   <!-- <b-breadcrumb>
    ...
    <h2 class="page-title"><span class="fw-semi-bold"></span></h2>
        <b-button variant="primary" class="btn-rounded-f width-100 mb-xs mr-xs" @click="navigateToCreate()">
            ...
            <br><br>
    <Widget
      title="<h4><span class='fw-semi-bold'>Vendor Listing - Publicly Acessible</span></h4>"
    ...
    <!--  <p>
        Fully customizable Table. Built with <a href="https://www.npmjs.com/package/vue-tables-2"
         ...
         <div class="table-responsive">
           <table class="table table-hover" id="vendordatatable1">
             <thead>
               <tr>
                  <th>ID</th>
                  <th>Name</th>
...
export default {
  ...
  mounted(){
      ...
      $(document).ready(function() {
          ...
          var table =  $('#vendordatatable1').DataTable( {
		"processing": true,
		"order": [[ 0, "id" ]],
        "serverSide": true,
          "dom": 'Bfrtip',
		"ajax": "https://backend.enigmedsvcs.com/development/vendor-public/admin",
		"columnDefs": [
    {
      "data": null,
    ...
    $('#vendordatatable1 tbody').on( 'click', '#edit', function () {
