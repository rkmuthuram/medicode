          ...
          <b-form @submit="onSubmit">
            <fieldset>
              ...
              >
                ...
                label-breakpoint="md"
                label-for="email"
                description="Primary login / Must be unique"
              >
                <input
            ...
            <b-form-group
              ...
              >
                ...
                <input
                  ...
                  name="ic_no"
                  :class="{ 'form-control': true, 'is-invalid': errors.has('ic_no')}"
                  type="text"
               v-model="data.ic_no"
                />
                <span class="text-danger" v-if="errors.has('ic_no')">
                  {{ errors.first('ic_no') }}
                </span>
              </b-form-group>
      <b-form-group
   ...
   this.accName= response.data.accountInfo[0].company_name;
    ...
    onSubmit(e) {
      ...
      self.$validator.validateAll().then((result) => {
		  if (result) {
                self.axios.post('https://backend.enigmedsvcs.com/development/workforce/admin', {
