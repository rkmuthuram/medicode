    ...
    // =============================================================================
      ...
      children: [
        ...
        },
        {
          path: '/inventory',
          name: 'inventory',
          component: () => import('./views/inventory/TableView.vue'),
          meta: {
            breadcrumb: [
              { title: 'Home', url: '/' },
              { title: 'Listing', active: true }
            ],
            pageTitle: 'Inventory',
            rule: 'isLoggedIn'
          }
        ...
        {
          path: '/manage-stock/:clinicId/:productId',
          name: 'manageStock',
          component: () => import('./views/inventory/ManageStock.vue'),
          meta: {
            breadcrumb: [
              { title: 'Home', url: '/' },
              { title: 'Inventory', url: '/inventory' },  
              { title: 'Manage Stock', active: true }
            ],
...

        {
          path: '/checkout',
          name: 'checkout',
          component: () => import('./views/checkout/NewCheckout.vue'),
          meta: {
            breadcrumb: [
              { title: 'Home', url: '/' },
              { title: 'New Check Out', active: true }
            ],
            pageTitle: 'Check Out',
            rule: 'isLoggedIn'
          }
        },
        {
          path: '/reports',
          name: 'reports',
          component: () => import('./views/reports/Generate.vue'),
          meta: {
            breadcrumb: [
              { title: 'Home', url: '/' },
              { title: 'Generate Reports', active: true }
            ],
            pageTitle: 'Reports',
            rule: 'isLoggedIn'
          }
        },
       {
        ...
        {
          path: '/listing-check-out',
          name: 'listing-check-out',
          component: () => import('@/views/extras/ListingCheckOut.vue'),
          meta: {
            breadcrumb: [
              { title: 'Home', url: '/' },
              { title: 'Check Out', active: true }
            ],
            pageTitle: 'Listings',
            rule: 'isLoggedIn'
          }
        },
        {
          ...
          component: () => import('@/views/extras/ListingHistory.vue'),
          meta: {
            breadcrumb: [
              { title: 'Home', url: '/' },
        ...
        {
          path: '/view-check-in/:checkInId',
          name: 'view-check-in',
          component: () => import('@/views/extras/ViewCheckIn.vue'),
          meta: {
            breadcrumb: [
              { title: 'Home', url: '/' },
              { title: 'Check In', active: true }
        ...
        {
          path: '/view-check-out/:checkOutId',
          name: 'view-check-out',
          component: () => import('@/views/extras/ViewCheckOut.vue'),
          meta: {
            breadcrumb: [
              { title: 'Home', url: '/' },
              { title: 'Check Out', active: true }
        ...
        },
        {
          path: '/file-manager',
          name: 'file-manager',
          component: () => import('@/views/extras/FileListing.vue'),
          meta: {
            breadcrumb: [
              { title: 'Home', url: '/' },
...
router.beforeEach((to, from, next) => {
  ...
  if(to.meta.rule!='isLoggedOut' && !localStorage.getItem('accessToken')){
