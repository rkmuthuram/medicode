    ...
    <div>
        <div class="vx-row">
            <div class="vx-col w-full sm:w-1/2 md:w-1/2 lg:w-1/4 xl:w-1/4 mb-base">
                <statistics-card-line
                  ...
                  statisticTitle="Staffs Performance"
            ...
            <div class="vx-col w-full sm:w-1/2 md:w-1/2 lg:w-1/4 xl:w-1/4 mb-base">
                <statistics-card-line
                  ...
                  statisticTitle="Meds Expiry Rating"
                ...
                <vx-card title="Stock Overview">
                    ...
                    <div class="flex justify-between text-center mt-6" slot="no-body-bottom">
                        ...
                        <div class="w-1/2 border border-solid d-theme-border-grey-light border-r-0 border-b-0">
                            <p class="mt-4">Fast Moving/Low</p>
        ...
        <div class="vx-row">
            ...
            <div class="vx-col w-full md:w-1/3 lg:w-1/3 xl:w-1/3 mb-base">
                <vx-card title="Client Statistics">
        ...
        <div class="vx-row">
            ...
            <div class="vx-col w-full lg:w-1/3 lg:mt-0 mt-base">
                <vx-card title="Orders By Device">
                    <!-- SLOT = ACTIONS -->
                    <template slot="actions">
