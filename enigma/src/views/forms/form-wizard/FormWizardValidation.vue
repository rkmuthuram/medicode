...
<template>
  <vx-card title="Check Out" code-toggler>
    ...
    <div class="mt-5">
      <form-wizard color="rgba(var(--vs-primary), 1)" errorColor="rgba(var(--vs-danger), 1)" :title="null" :subtitle="null" finishButtonText="Submit">
        <tab-content title="Customer Info" class="mb-5" icon="feather icon-home" :before-change="validateStep1">
          ...
          <div class="vx-row">
            <div class="vx-col md:w-1/2 w-full mt-5">
              <vs-input label="Patient MRN" v-model="firstName" class="w-full" name="first_name" v-validate="'required|alpha'" />
        ...
        <!--    <div class="vx-col md:w-1/2 w-full mt-5">
            ...
            <div class="vx-col md:w-1/2 w-full mt-5">
              <vs-input type="email" label="Patient Email"  v-model="email" class="w-full" name="email" v-validate="'required|email'" />
              <span class="text-danger">{{ errors.first('step-1.email') }}</span>
            </div>
                  <div class="vx-col md:w-1/2 w-full mt-5">
              <vs-input label="Amount (RM)" v-model="firstName" class="w-full" name="first_name" v-validate="'required|alpha'" />
              <span class="text-danger">{{ errors.first('step-1.first_name') }}</span>
            </div>
        <!--    <div class="vx-col md:w-1/2 w-full mt-5">
