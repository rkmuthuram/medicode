<template>
  <div>
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active">Member Password Reset</li>
    </ol>
    ...
    onSubmit(e) {
     var self = this;
      ...
      self.$validator.validateAll().then((result) => {
		  if (result) {
                self.axios.patch('https://backend.medicodesolution.com/staging/members/admin/reset-password/'+this.token+'/'+this.email, {
