<template>
  <div>
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active">Staff Password Reset</li>
    </ol>
  
  <a href="https://kka-pj.web.app/" > <h1 class="page-title" v-if="completed==true">Password Reset Successful! <span class="fw-semi-bold">Proceed to Login </span> </h1></a>

    <b-row   v-if="completed=='false'">
      <b-col xs='0' lg='1' />
      <b-col lg='8' xs='12'>
        <Widget
          title="<h5>
    ...
    onSubmit(e) {
     var self = this;
      ...
      self.$validator.validateAll().then((result) => {
		  if (result) {
                self.axios.patch('https://backend.medicodesolution.com/staging/workforce/admin/reset-password/'+this.token+'/'+this.email, {
