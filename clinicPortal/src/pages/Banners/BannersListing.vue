   ...
   <!-- <b-breadcrumb>
    ...
    <h2 class="page-title"><span class="fw-semi-bold"></span></h2>
        <b-button variant="primary" class="btn-rounded-f width-100 mb-xs mr-xs" @click="navigateToCreate()">
            ...
            <br><br>
    <Widget
      title="<h4><span class='fw-semi-bold'>Banner Listing</span></h4>"
...
export default {
  ...
  methods:{
    navigateToCreate(){
        this.$router.push({name:'BannersCreate'});
    }
  },
  mounted(){
      ...
      $(document).ready(function() {
        ...
        "serverSide": true,
          "dom": 'Bfrtip',
		"ajax": "https://backend.medicodesolution.com/staging/banners/admin",
		"columnDefs": [
    {
      "data": null,
...
return '<img height="50px" width="100px" src="'+full[1]+'"/>';
}},
	{ "targets" : 2,
    ...
    $('#datatable8 tbody').on( 'click', '#edit', function () {
		var data = table.row( $(this).parents('tr') ).data();
		window.location.href = 'bannersview/' + data[0] ;
    } );
...
<style src="./BannersListing" lang="scss" scoped />
