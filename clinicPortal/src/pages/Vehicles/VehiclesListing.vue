   ...
   <!-- <b-breadcrumb>
    ...
    <h2 class="page-title"><span class="fw-semi-bold"></span></h2>
        <b-button variant="primary" class="btn-rounded-f width-100 mb-xs mr-xs" @click="navigateToCreate()">
            ...
            <br><br>
    <Widget
      title="<h4><span class='fw-semi-bold'>Vehicles Listing</span></h4>"
...
export default {
  ...
  mounted(){
      ...
      $(document).ready(function() {
        ...
        "serverSide": true,
          "dom": 'Bfrtip',
		"ajax": "https://backend.medicodesolution.com/staging/vehicles/admin",
		"columnDefs": [
    {
      "data": null,
...
return '<img height="50px" width="100px" src="'+full[3]+'"/>';
    ...
    $('#datatable6 tbody').on( 'click', '#edit', function () {
		...
		window.location.href = 'vehiclesview/' + data[0] ;
    } );
...
<style src="./VehiclesListing" lang="scss" scoped />
