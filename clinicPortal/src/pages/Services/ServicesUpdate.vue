<template>
  <div>
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active">Update Service - {{data.title}}</li>
    </ol>
    ...
    <b-row>
     ...
     <b-form-group
              ...
              <b-form-group
                ...
                description="Approx time taken in Minutes for service to complete"
              >
                <div slot="label">
                  Time Taken 
                </div>
...
export default {
  ...
  data() {
    return {
     serviceId: this.$route.params.serviceId,
      ...
      isLoading:false,
       dropzoneOptions: {
          url: 'https://backend.medicodesolution.com/staging/services/upload',
          thumbnailWidth: 150,
          maxFilesize: 5.0,
           maxFiles: 5,
          addRemoveLinks: true,
  ...
  methods: {
    navigateToList(){
        this.$router.push({name:'ServicesListing'});
    },
    removeCoverImage(i){
 ...
 self.axios.patch('https://backend.medicodesolution.com/staging/services/'+ this.serviceId, {
