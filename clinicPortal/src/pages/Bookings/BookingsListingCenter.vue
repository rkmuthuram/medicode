   ...
   <!-- <b-breadcrumb>
    ...
    <h2 class="page-title"><span class="fw-semi-bold"></span></h2>
        <b-button variant="primary" class="btn-rounded-f width-100 mb-xs mr-xs" @click="navigateToCreate()">
            ...
            <br><br>
    <Widget
      title="<h4><span class='fw-semi-bold'> Center Bookings Listing</span></h4>"
...
export default {
  ...
  data() {
    return {
     dataTable:null,
     workforceCenter:window.localStorage.getItem('workforceCenter'),
    };
  },
  methods:{
    navigateToCreate(){
  ...
  mounted(){
    ...
    var workforceCenter = localStorage.getItem('workforceCenter');
          var table =  $('#datatable5').DataTable( {
		"processing": true,
		"order": [[ 0, "id" ]],
        "serverSide": true,
          "dom": 'Bfrtip',
		"ajax": "https://backend.medicodesolution.com/staging/schedule_center/admin/"+workforceCenter,
		"columnDefs": [
    {
      "data": null,
