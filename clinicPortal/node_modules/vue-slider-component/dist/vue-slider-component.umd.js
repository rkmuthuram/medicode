    ...
    value: function setDotsValue(value, syncPos) {
      ...
      if (this.included && this.markList.length > 0) {
        var getRecentValue = function getRecentValue(val) {
          var curValue = val;
          var dir = _this.max - _this.min;

          _this.markList.forEach(function (mark) {
    ...
    value: function getValues() {
      ...
      if (this.data) {
        ...
        return Array.from(new Array(this.total), function (_, index) {
          return new Decimal(index).multiply(_this6.interval).plus(_this6.min).toNumber();
        }).concat([this.max]);
      }
    }
  }, {
